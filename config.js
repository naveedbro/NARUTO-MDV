...
MODERATORS : process.env.MODERATORS === undefined ? "923096566451" : process.env.MODERATORS ,
...
HEROKU_APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'NARkUTO' : process.env.HEROKU_APP_NAME,
