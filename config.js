...
MODERATORS : process.env.MODERATORS === undefined ? "923096566451,919083366564" : process.env.MODERATORS ,
...
HEROKU_APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'NARUTO-MD' : process.env.HEROKU_APP_NAME,
